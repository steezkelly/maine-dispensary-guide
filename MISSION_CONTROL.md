...
>
> Last regenerated: 2026-07-09 12:49 UTC
...
- Last commit: `e1f7e1d6` — chore(hub): MISSION_CONTROL regen post-build (sprint-score refresh) (2026-07-09, branch: main)
...
- Guide pages: 193
- Blog posts: 36
- Last commit: e1f7e1d6 — chore(hub): MISSION_CONTROL regen post-build (sprint-score refresh)
...
*Generated by scripts/admin/build-mission-control.cjs on 2026-07-09 12:49 UTC. For the canonical source, see /status.json.*
