...
>
> Last regenerated: 2026-07-09 04:49 UTC
...
- Last commit: `54bb82f6` — feat(roi): ROI calculator — Maine + national benchmark tables, primary-source citations, FAQPage schema (2026-07-09, branch: main)
...
- Guide pages: 193
- Blog posts: 36
- Last commit: 54bb82f6 — feat(roi): ROI calculator — Maine + national benchmark tables, primary-source citations, FAQPage schema
...
*Generated by scripts/admin/build-mission-control.cjs on 2026-07-09 04:49 UTC. For the canonical source, see /status.json.*
