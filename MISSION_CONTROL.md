...
>
> Last regenerated: 2026-07-08 16:40 UTC
...
- 224-page HEAD smoke: 267 html / 263 sitemap URLs
- Last commit: `331188fe` — docs(lead-funnel): SOP trust-gap callout + Stage 1 session-handoff prompt (2026-07-08, branch: main)
...
- Total pages (dist/): 267
- Sitemap URLs: 263
- Guide pages: 191
- Blog posts: 36
- Last commit: 331188fe — docs(lead-funnel): SOP trust-gap callout + Stage 1 session-handoff prompt
...
*Generated by scripts/admin/build-mission-control.cjs on 2026-07-08 16:40 UTC. For the canonical source, see /status.json.*
