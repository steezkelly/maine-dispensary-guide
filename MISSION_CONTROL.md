...
>
> Last regenerated: 2026-07-13 02:08 UTC
...
- Last commit: `bd83ccef` — fix(readability): swap --color-primary text refs to --color-text/-cream-ink/-on-primary (2026-07-12, branch: readability/audit-sweep-2026-07-13)
...
- Guide pages: 193
- Blog posts: 36
- Last commit: bd83ccef — fix(readability): swap --color-primary text refs to --color-text/-cream-ink/-on-primary
...
*Generated by scripts/admin/build-mission-control.cjs on 2026-07-13 02:08 UTC. For the canonical source, see /status.json.*
