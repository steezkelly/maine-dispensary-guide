...
>
> Last regenerated: 2026-07-10 10:51 UTC
...
## System Status (last verified 2026-07-10)

- Production site: [LIVE](https://mainedispensaryguide.com)
- Sprint-Score: WARN (11/11 (1 warnings))
- 224-page HEAD smoke: 273 html / 269 sitemap URLs
- Last commit: `6149aeec` — docs(hub): log Vercel header-precedence gotcha as production-realization epilogue (2026-07-09, branch: main)
- IndexNow last: 2026-07-06T20:18:20.428Z — 200 — ? URLs
- OCP stats last refresh: 2026-07-08 — stored 187 → live 107 (drift -80)

---

## Content Intelligence (current as of 2026-07-10)

- Total pages (dist/): 273
- Sitemap URLs: 269
- Guide pages: 193
- Blog posts: 36
- Last commit: 6149aeec — docs(hub): log Vercel header-precedence gotcha as production-realization epilogue
...
## Bot Collaboration Sync (current as of 2026-07-10)
...
*Generated by scripts/admin/build-mission-control.cjs on 2026-07-10 10:51 UTC. For the canonical source, see /status.json.*
