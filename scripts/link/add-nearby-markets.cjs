...
const cityNeighbors = {
  ...
  'kittery': [
    { city: 'Portland', distance: '50 miles', href: '/guides/portland-dispensary-guide', notes: 'Largest Maine market' },
...
function addNearbyMarketsToFile(filePath, cityName, slug) {
  ...
  if (content.includes(insertBefore)) {
    content = content.replace(insertBefore, `</section> ${section} <section class="disclaimer">`);
