...
| `../apps/maine-cannabis/docs/research/q3-2026-data/ocp-au-licenses-2026-06-01.csv` | OCP adult-use licensee-search CSV, dated June 1, 2026 (1,584 raw rows = 346 unique active licenses after dedupe). |
| `../apps/maine-cannabis/docs/research/q3-2026-data/ocp-med-caregivers-2026-06-01.csv` | OCP medical caregiver registrant search CSV, dated June 1, 2026 (1,415 raw rows = 1,414 unique rows). |
| `../apps/maine-cannabis/docs/research/q3-2026-data/ocp-med-establishments-2026-06-01.csv` | OCP medical dispensary/establishment roster CSV, dated June 1, 2026 (805 raw rows = 104 unique dispensary licenses). |
