...
| Guide title trim | Committed candidate exists | Title-trim owner, then integration review | Do not touch the guide-title paths outside its worktree. Rebase only if `origin/main` moves, preserve its isolated scope, verify, then hand off one candidate. | `chore/guides-title-trim-2026-07-14` worktree |
