...
| `email/mdg-replies-monotonicity` | Superseded by aggregate branch | Its two commits are ancestors of `mdg-analytics-001/ticket-007-ingest`; do not create a second integration path outside that owner-governed aggregate. |
| `feat/contributor-guidelines-funnel-2026-07-13` | Needs owner/semantic decision | Although technically clean, its `contribute.astro` edit changes ownership/byline, editorial contact, response commitments, and reciprocity policy. |
...
| `feat/trust-pages-cookies-accessibility-advertising-medical-2026-07-13` | Needs owner/semantic decision | It makes public cookie, analytics, WCAG, GDPR/CCPA, response-time, and advertising representations; owner/legal approval is required despite applying cleanly. |
...
| `wt/cherry-pick-title-tranche-2026-07-13` | Duplicate | Main already has the active title-tranche tools and shipped title tranche; this branch adds relocated inactive tooling plus older index/all-guides edits. Do not duplicate it. |
