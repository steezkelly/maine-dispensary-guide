...
export const CORRECTIONS: Correction[] = [
  {
    ...
    title: "Opt-In Tracker dataset — rebuilt against OCP primary sources: removed 13 towns without recorded retail authorization (incl. Bar Harbor and Wells, which rejected retail by vote), re-derived all store counts from the OCP roster",
    severity: "critical",
    category: "operator-data",
    what_was_wrong:
      "The CC BY 4.0 dataset behind /embed/opt-in-tracker, /for-journalists, and /market-pulse-2026 (maine-opt-in-towns.json, last updated 2026-04-15, 34 towns) was contradicted by the OCP's own data on two axes. (1) Opt-in status: 13 of 34 listed towns have NO recorded adult-use retail authorization in the OCP municipal opt-in model (refreshed 2026-07-09, maine.gov/dafs/ocp/open-data/adult-use/opt-in-communities): Westbrook, Scarborough, Saco, Topsham, Camden, Bar Harbor, Dover-Foxcroft, Caribou, Houlton, York, Wells, Skowhegan, Belfast. Two of those are proven vote rejections: Bar Harbor voters turned down citizen-initiated retail ordinances at town meeting in June 2022 and again in November 2022 (Mount Desert Islander; Bangor Daily News 2022-11-09); Wells voters rejected adult-use retail June 10, 2025 (Article 17, York County Star / Seacoast Online). The dataset nonetheless listed them as opted-in — including Bar Harbor with 'dispensaries_operating: 2' — and the journalist-facing citation formats propagated the aggregate ('34 municipalities', '41+-town patchwork'). (2) Store counts: every one of the remaining 21 OCP-verified opted-in towns was undercounted or stale against the OCP licensee roster of 2026-07-01 — Portland was 12 vs 27 active store licenses, South Portland 0 vs 12, Bangor 6 vs 10, Lewiston 4 vs 8, Auburn 2 vs 7, Augusta 0 vs 5, Waterville 1 vs 6, Rockland 2 vs 4, Sanford 1 vs 4, etc. Three downstream prose errors propagated from the dataset: the Bar Harbor dispensary guide claimed Bar Harbor 'opted in 2019' (three places), the Greater Portland / Sebago Lakes cluster guide claimed Westbrook 'opted in for adult-use retail in 2019' and Scarborough 'has two active dispensaries', the York guide claimed York 'has opted in to recreational cannabis retail', and the Dover-Foxcroft guide FAQ cited the stale tracker as proof of opt-in.",
    what_is_correct:
      "The dataset now lists exactly the 21 towns the OCP municipal opt-in model (2026-07-09) records as retail-authorized, spanning 10 counties, with dispensaries_operating re-derived as active adult-use Store licenses per the OCP licensee roster of 2026-07-01: Portland 27, South Portland 12, Bangor 10, Lewiston 8, Auburn 7, Waterville 6, Augusta 5, Sanford 4, Rockland 4, Biddeford 3, Brunswick 3, Kittery 3, Brewer 3, Gardiner 3, Bath 2, Wiscasset 1, Presque Isle 1, Old Orchard Beach 1, Orono 1, Winslow 1, Ellsworth 0 (authorized, no active store license). Meta now documents the method. Removed towns and their status: Bar Harbor and Wells rejected retail by vote (2022, 2025); Westbrook, Scarborough, Saco, Topsham, Camden, Dover-Foxcroft, Caribou, Houlton, York, Skowhegan, Belfast have no OCP-recorded retail authorization (verify with town clerk). All downstream prose corrected: Bar Harbor guide (3 spots), Greater Portland / Sebago Lakes guide (Westbrook + Scarborough), York guide (status section + FAQ), Dover-Foxcroft guide (FAQ), market-pulse-2026 (Portland/Bangor/Sanford hardcoded counts), for-journalists ('41+-town patchwork').",
    verified_via: [
      ...
      { label: "OCP adult-use licensee roster CSV (2026-07-01) — store-count re-derivation", url: "https://www.maine.gov/dafs/ocp/sites/maine.gov.dafs.ocp/files/inline-files/Adult_Use_Establishments_And_Contacts_2026_07_01.csv" },
    ...
    published_in: [
      ...
      { name: "Audit narrative: We Removed 13 Towns From Maine's Cannabis Opt-In Tracker", href: "/blog/maine-opt-in-tracker-audit-2026" },
    ],
  },
  {
    date: "2026-08-11",
    ...
    what_is_correct:
      "420 Mules — registered Maine medical caregiver (delivery, no public storefront), serves MMMP patients on MDI; call 207-801-0839. The Meristem — 11 Seal Cove Rd, Southwest Harbor, the only active adult-use store license in Hancock County (OCP AMS600, active through Jun 2027), Tue–Sat 10am–6pm. Snare Creek Farms — 211 Bar Harbor Rd, Trenton, medical-only dispensary (MMMP required); adult-use AMS1850 still Pending Conditional. The Happier Choice — medical caregiver retail in Trenton (OCP caregiver roster). Bar Harbor holds no active adult-use store license per the 2026-07-01 OCP roster and has not authorized retail (voters rejected citizen-initiated ordinances in June and November 2022). Possession limit: 2.5 oz cannabis, incl. up to 10 g concentrate (28-B M.R.S. §1501(1)(B)). Acadia: 3.96M recreation visits 2024 (NPS, 7th most-visited NPS unit). Bar Harbor population: 5,089 (2020 Census), 5,352 est. 2025 (Census Bureau).",
    verified_via: [
