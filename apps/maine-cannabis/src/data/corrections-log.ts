...
export const CORRECTIONS: Correction[] = [
  {
    date: "2026-08-11",
    slug: "maine-opt-in-towns-dataset",
    title: "Opt-In Tracker dataset — rebuilt to the complete OCP-authorized statewide universe: removed 13 unsupported rows, added 57 missing authorized municipalities, re-derived active Store counts",
    severity: "critical",
    category: "operator-data",
    what_was_wrong:
      "The CC BY 4.0 dataset behind /embed/opt-in-tracker, /for-journalists, and /market-pulse-2026 (maine-opt-in-towns.json, last updated 2026-04-15, 34 towns) was contradicted by the OCP's own data on three axes. (1) Opt-in status: 13 of 34 listed towns have NO recorded adult-use retail authorization in the OCP municipal opt-in model (refreshed 2026-07-09, maine.gov/dafs/ocp/open-data/adult-use/opt-in-communities): Westbrook, Scarborough, Saco, Topsham, Camden, Bar Harbor, Dover-Foxcroft, Caribou, Houlton, York, Wells, Skowhegan, Belfast. Two of those are proven vote rejections: Bar Harbor voters turned down citizen-initiated retail ordinances at town meeting in June 2022 and again in November 2022 (Mount Desert Islander; Bangor Daily News 2022-11-09); Wells voters rejected adult-use retail June 10, 2025 (Article 17, York County Star / Seacoast Online). The dataset nonetheless listed them as opted-in — including Bar Harbor with 'dispensaries_operating: 2' — and the journalist-facing citation formats propagated the aggregate ('34 municipalities', '41+-town patchwork'). (2) Completeness: the 34-row file was a partial fee/detail table, not the statewide authorization universe; after removing the 13 unsupported rows, retaining only 21 would still omit 57 OCP-authorized incorporated municipalities and understate the statewide count of 78. (3) Store counts: every one of the remaining 21 OCP-verified opted-in towns was undercounted or stale against the OCP licensee roster retrieved 2026-08-11 — Portland was 12 vs 27 active store licenses, South Portland 0 vs 12, Bangor 6 vs 10, Lewiston 4 vs 8, Auburn 2 vs 7, Augusta 0 vs 5, Waterville 1 vs 6, Rockland 2 vs 4, Sanford 1 vs 4, etc. Three downstream prose errors propagated from the dataset: the Bar Harbor dispensary guide claimed Bar Harbor 'opted in 2019' (three places), the Greater Portland / Sebago Lakes cluster guide claimed Westbrook 'opted in for adult-use retail in 2019' and Scarborough 'has two active dispensaries', the York guide claimed York 'has opted in to recreational cannabis retail', and the Dover-Foxcroft guide FAQ cited the stale tracker as proof of opt-in.",
    what_is_correct:
      "The dataset now covers the complete statewide universe of 78 incorporated municipalities that the OCP model (refreshed 2026-07-09) records as retail-authorized, spanning all 16 counties. It removes the 13 unsupported legacy rows and adds the 57 authorized municipalities omitted by the old detail table. dispensaries_operating is re-derived as distinct active adult-use Store license IDs per the OCP roster retrieved 2026-08-11 (source filename dated 2026-07-01; HTTP Last-Modified 2026-08-10), with documented canonical place-name normalization: 184 active Store licenses link to the 78 authorized municipalities; roster locations that conflict with the authorization model are excluded pending reconciliation. The 21 previously reviewed rows retain their opt-in-year and municipal-fee details; the 57 additions use null for those fields rather than an estimate. The canonical 485-municipality model reports 78 retail-authorized, 407 with no OCP-recorded retail authorization, and zero evidence-backed explicit opt-outs; an OCP N activity flag alone is not treated as proof of a local rejection vote. Removed towns and their status: Bar Harbor and Wells rejected retail by vote (2022, 2025); Westbrook, Scarborough, Saco, Topsham, Camden, Dover-Foxcroft, Caribou, Houlton, York, Skowhegan, and Belfast have no OCP-recorded retail authorization (verify with town clerk). Downstream citation and market-report surfaces now distinguish statewide authorization counts from the 21-row fee/year detail subset.",
    verified_via: [
      { label: "OCP municipal opt-in model (maine-municipal-authorization.json, refreshed from OCP 2026-07-09)", url: "https://www.maine.gov/dafs/ocp/open-data/adult-use/opt-in-communities" },
      { label: "OCP adult-use licensee roster CSV — retrieved 2026-08-11; filename dated 2026-07-01, HTTP Last-Modified 2026-08-10; SHA-256 37c678ced16a14eaba81821f254b5596bf6b1ee3f5a4619ef95a17dfa2aee0fa — store-count re-derivation", url: "https://www.maine.gov/dafs/ocp/sites/maine.gov.dafs.ocp/files/inline-files/Adult_Use_Establishments_And_Contacts_2026_07_01.csv" },
      { label: "Bangor Daily News 2022-11-09 — 'Bar Harbor voters also voted against allowing recreational marijuana shops'", url: "https://www.bangordailynews.com/2022/11/09/hancock/bar-harbor-cruise-ships-election/" },
      { label: "Mount Desert Islander — Bar Harbor retail initiatives (June 2022 town-meeting rejection; November 2022 ballot)", url: "https://www.mdislander.com/maine-news/bar-harbor-to-consider-adult-use-marijuana-shops-again" },
      { label: "Seacoast Online 2025-06-10 — Wells voters reject recreational cannabis (Article 17)", url: "https://www.seacoastonline.com/story/news/local/york-star/2025/06/10/wells-maine-election-results-voters-nix-recreational-cannabis-select-board-race/84129030007/" },
      { label: "MDG generated retail-licenses product (data_as_of 2026-06-01, 187 active AU store licenses statewide) — counting-method cross-check", url: "https://mainedispensaryguide.com/market-stats" },
    ],
    published_in: [
      { name: "Opt-In Tracker (embed)", href: "/embed/opt-in-tracker" },
      { name: "For Journalists", href: "/for-journalists" },
      { name: "Market Pulse 2026", href: "/market-pulse-2026" },
      { name: "Bar Harbor dispensary guide", href: "/guides/bar-harbor-dispensary-guide" },
      { name: "Greater Portland / Sebago Lakes cluster guide", href: "/guides/greater-portland-sebago-lakes-cannabis-guide" },
      { name: "York dispensary guide", href: "/guides/york-dispensary-guide" },
      { name: "Dover-Foxcroft dispensary guide", href: "/guides/dover-foxcroft-dispensary-guide" },
      { name: "Audit narrative: Maine Cannabis Opt-In Tracker Audit — 13 Removed, 57 Added", href: "/blog/maine-opt-in-tracker-audit-2026" },
    ],
  },
  {
    date: "2026-08-11",
    ...
    category: "operator-data",
    what_was_wrong:
      "The guide (as corrected 2026-07-29) still carried four material license-status errors. (1) It listed 420 Mules as 'Recreational (21+) and Medical (MMMP)' with a storefront on Main Street; the OCP adult-use roster retrieved 2026-08-11 contains no adult-use license for 420 Mules anywhere, and the operator's own site describes a medical delivery service — it is a registered caregiver (Michael J. Adelmann, dba 420 Mules, active through Jan 2027). (2) It listed Snare Creek Farms as 'Recreational and Medical'; the operator's own site and the OCP medical caregiver roster say medical-only (adult-use application AMS1850 is Pending Conditional). (3) The quick-facts row 'Recreational Legal — Yes, town permits adult-use retail' and the FAQ answer 'Bar Harbor permits adult-use cannabis retail' implied a licensed Bar Harbor storefront exists; the OCP roster shows zero active adult-use store licenses in Bar Harbor and the OCP municipal opt-in model records no retail authorization (Bar Harbor voters rejected retail ordinances in June and November 2022). (4) The possession-limits FAQ said '5 g of concentrate, and edibles totaling 100 mg THC'; the statute (28-B M.R.S. §1501(1)(B), per OCP's consumer FAQ) is 2.5 oz of cannabis or a combination thereof including no more than 10 grams of concentrate, with no 100 mg edibles rule in that provision. The guide also said Acadia draws '~4 million visitors annually' and Bar Harbor has '~5,500 year-round residents (2020 Census)' — the precise NPS figure is 3.96M recreation visits in 2024 and the 2020 Census count is 5,089.",
    what_is_correct:
      "420 Mules — registered Maine medical caregiver (delivery, no public storefront), serves MMMP patients on MDI; call 207-801-0839. The Meristem — 11 Seal Cove Rd, Southwest Harbor, the only active adult-use store license in Hancock County (OCP AMS600, active through Jun 2027), Tue–Sat 10am–6pm. Snare Creek Farms — 211 Bar Harbor Rd, Trenton, medical-only dispensary (MMMP required); adult-use AMS1850 still Pending Conditional. The Happier Choice — medical caregiver retail in Trenton (OCP caregiver roster). Bar Harbor holds no active adult-use store license per the OCP roster retrieved 2026-08-11 and has not authorized retail (voters rejected citizen-initiated ordinances in June and November 2022). Possession limit: 2.5 oz cannabis, incl. up to 10 g concentrate (28-B M.R.S. §1501(1)(B)). Acadia: 3.96M recreation visits 2024 (NPS, 7th most-visited NPS unit). Bar Harbor population: 5,089 (2020 Census), 5,352 est. 2025 (Census Bureau).",
    verified_via: [
      { label: "OCP adult-use licensee roster retrieved 2026-08-11 (filename dated 2026-07-01; HTTP Last-Modified 2026-08-10): AMS600 Meristem active; AMS1850 Snare Creek Pending Conditional; no 420 Mules; no Bar Harbor stores", url: "https://www.maine.gov/dafs/ocp/sites/maine.gov.dafs.ocp/files/inline-files/Adult_Use_Establishments_And_Contacts_2026_07_01.csv" },
  ...
  },
  {
    ...
    published_in: [
      {
        name: "Maine Cannabis Cultivation License: Tiers, Fees & How to Apply (2026)",
        href: "/blog/maine-cannabis-cultivation-license-2026"
      }
    ]
  },
  {
